...
int Engine::on_connect (void* ctx, int slot, void* data, size_t data_len) {
...
int Engine::on_transport_ready (void* ctx, int slot, void* data, size_t data_len) {
...
int Engine::on_disconnect (void* ctx, int slot, void* data, size_t data_len) {
